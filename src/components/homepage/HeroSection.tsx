...
//           <Button
//             asChild
//             className="bg-[#E18731] hover:bg-[#E18731]/100 text-[#1a1a1a] text-lg font-medium rounded-full"
//           >
//             <Link to="/register">
//               Register Now
//             </Link>
      ...
      <section className="hero-section relative min-h-[70vh] md:min-h-[80vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="hero-content animate-fade-in">
          ...
          <p className="hero-subtitle">
            Join hundreds of runners for an unforgettable race through the
            beautiful landscapes of Pugu for Tsh.30,000 only.
          </p>
