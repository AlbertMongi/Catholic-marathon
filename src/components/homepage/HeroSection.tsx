    ...
    <>
      ...
      <section className="hero-section relative min-h-[70vh] md:min-h-[80vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="hero-content">
          ...
          {/* Bigger, Bold, Orange, Italic Subtitle */}
        <h2 className="text-xl md:text-2xl lg:text-4xl italic font-bold text-[#FAC31C] tracking-wider  mb-4">
  <strong>{t("hero_title1")}</strong>
</h2>
         ...
         <Button
  asChild
  className="group bg-[#6A10CB] hover:bg-[#6A10CB]/90 
    text-white text-2xl font-bold 
    rounded-full px-14 py-8 
    shadow-2xl hover:shadow-[0_25px_70px_rgba(106,16,203,0.6)] 
    transition-all duration-300 
    flex items-center gap-5 hover:scale-105"
>
