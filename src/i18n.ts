...
const resources = {
  ...
  "Join thousands of runners to raise more than 600 million shillings for commmunity development support at large.",
      ...
      feature_register: "Pugu Pilgrimage Centre",
      ...
      feature_media_desc:
       ...
       marathon_moments_title: "Pugu Marathon 2025 Moments & Highlights",
    ...
    our_mission_content: "To bring together people from all walks of life without discrimination. The initiative envisions to  support the improvement of community health, education, vocational skills, youth empowerment, environmental sustainability and the improvement of the Pugu Pilgrimage Center. We believe that by working together, we can create a positive and lasting change in our community.",
  ...
  "mhazini": "Treasurer",
    ...
    form_send_message: "Send Message",
     health_desc:
        "To support the improvement of Pugu Health Centre.",
           community_focus_title: "Our Community Focus",
            education_desc:
        "To support the improvement of Pugu Secondary school.",
        health_title: "Health",
             environment_desc:
...
"form.registering": "registering...",
  "minRegistrationAmount": "Minimum amount: TZS 30,000",
    "minContributionAmount": "Minimum amount: TZS 1,000",
  "success.thank_you": "Thank You!",
      "mshiriki1": "I am participating in marathon",
...
"payment.processing": "Processing...",
  "network": "Network",
    ...
    "haloPesa": "HaloPesa",
    "mobilePaymentNumber": "Mobile Payment Number",
...
'validation.sex_required': 'Choose sex',
  ...
  "contributor": "Contributor",
   "contributor1": "I want to contribute only",
...
"registering": "Registering...",
  ...
  // STEPS FOR PAYMENT
    ...
    'ok_pay_later'           : "OK, I'll Pay Later",
     "form.first_name": "First Name",
      "payViaMobile": "Please pay via mobile",
    "paymentSentInstructions": "A payment request has been sent to your phone. Please complete the payment to finalize registration, or use the reference number sent to your phone with company number 686686 for Halotel, Mixx by Yas, and Airtel networks. Use 944344 for Vodacom.",
  ...
  "sex.male": "Male",
  "sex.female": "Female",
  //  "payViaMobile": "Pay via Your Mobile",
    "useBillNumberToPay": "Use the bill number below to pay quickly and securely via your phone.",
    "billNumber": "Bill Number",
    // "tigoPesa": "Mixx by Yas",
    "tigoStep1": "Dial *150*01#",
    "tigoStep2": "Select Pay Bill",
    "tigoStep3": "Enter Bill Number: 686686",
    "tigoStep4": "Enter reference number if required",
    "tigoStep5": "Enter amount",
    "tigoStep6": "Enter your Tigo Pesa PIN to confirm",
    // "airtelMoney": "Airtel Money",
    "airtelStep1": "Dial *150*60#",
    "airtelStep2": "Select 5 – Pay Bill",
    "airtelStep3": "Select More if needed",
    "airtelStep4": "Select Fintech or Merchant Payments",
    "airtelStep5": "Select EvMak or similar option",
    "airtelStep6": "Enter Bill/Reference Number: 686686",
    "airtelStep7": "Enter amount",
    "airtelStep8": "Enter your PIN to confirm",
    // "haloPesa": "Halopesa",
    "haloStep1": "1. Dial *150*88#",
    "haloStep2": "2. Select Pay Bill",
    "haloStep3": "3. Enter Company Number: 686686",
    "haloStep4": "4. Enter reference number if needed",
    "haloStep5": "5. Enter amount",
    "haloStep6": "6. Enter your PIN to confirm",
    // "mpesa": "Mpesa",
    "mpesaStep1": "Dial *150*00#",
    "mpesaStep2": "Pay via Mpesa",
    "mpesaStep3": "Enter Company Number: 944344",
    "mpesaStep4": "Enter reference number if required",
    "mpesaStep5": "Enter amount",
    "mpesaStep6": "Enter your Halo Pesa PIN to confirm",
    "mpesaStep7": "Confirm payment",
    "afterPaymentMessage": "After payment, you will receive a confirmation message. Your registration will be automatically completed.",
    "goHome": "Go Home",
...
feature_register_desc:
  "Kuchangia maendeleo ya ujenzi wa kituo cha Hija Pugu",
      ...
      feature_media_desc:
        "Tazama matukio yaliyorekodiwa ya marathon, mahojiano na washiriki, na mihadhara ya motisha kutoka matukio ya awali.",
         marathon_moments_title: "Matukio ya Pugu Marathon 2025",
    ...
    race_day_excitement: "Jiunge na maelfu ya wakimbiaji katika tukio la kijamii",
    ...
    footer_tagline: "Kimbia • Jumuika • Hamasisha",
    ...
    health_desc:
        "Kuwezesha maendeleo kituo cha afya Pugu",
  ...
  "form.tshirt_size": "Ukubwa wa T-shirt",
  "form.select_size": "-- Chagua ukubwa wa T-shirt --",
  "form.membership": "Uanachama",
  "form.select_membership": "-- Chagua aina ya uanachama --",
  "form.decania": "Dekania",
...
"form.required_fields": "Sehemu zinazohitajika",
 "minRegistrationAmount": "Kiasi cha chini: TZS 30,000",
    "minContributionAmount": "Kiasi cha chini: TZS 1,000",
...
"payment.accept_terms_prefix": "Nakubali",
 "catholic": "Mkatoliki",
    "nonCatholic": "Si Mkatoliki",
"payment.participant": "Mshiriki",
  // Race distances
  "race.2km": "2 Km",
  "race.5km": "5 Km",
  "race.10km": "10 Km",
   "payLater": "Lipa Baadae",
...
"payment.processing": "Inashughulikia...",
 "network": "Mtandao",
    ...
    "airtelMoney": "Airtel Money",
    "haloPesa": "HaloPesa",
    "mobilePaymentNumber": "Namba ya Simu ya Malipo",
    "phonePlaceholder": "07XXXXXXXX",
    "email": "Barua Pepe",
    "emailPlaceholder": "mfano@barua.pepe",
    "phoneNumber": "Namba ya Simu",
    "address": "Anwani",
    "agreeTerms": "Nimeyasoma na kukubali",
    "termsAndConditions": "Sheria na Masharti",
     "payViaMobile": "Lipa kwa Simu Yako",
    "useBillNumberToPay": "Tumia namba ya bili ifuatayo kulipa haraka na salama kupitia simu yako.",
    "billNumber": "Namba ya Bili (Bill Number)",
  
    "tigoStep1": "Piga *150*01#",
    "tigoStep2": "Chagua namba ya Lipa Bili / Pay Bill",
    "tigoStep3": "Ingiza namba ya Kampuni: 686686",
    "tigoStep4": "Ingiza namba ya marejeleo (Reference)",
    "tigoStep5": "Ingiza kiasi",
    "tigoStep6": "Ingiza PIN yako ya Tigo Pesa kuthibitisha",

    "airtelStep1": "Piga *150*60#",
    "airtelStep2": "Chagua 5 – Lipa Bili / Malipo",
    "airtelStep3": "Chagua More (zaidi)",
    "airtelStep4": "Chagua Fintech au Merchant Payments",
    "airtelStep5": "Chagua EvMak au chaguo linalofanana",
    "airtelStep6": "Ingiza namba ya kumbukumbu iliyotumwa kwenye simu yako ukianza na maneno EVM (mfano EVMPMT25224252)",
    "airtelStep7": "Ingiza kiasi",
    "airtelStep8": "Ingiza PIN yako kuthibitisha",

    "haloStep1": "1.Piga *150*88#",
    "haloStep2": "2.Chagua Lipa Bili",
    "haloStep3": "3.Weka namba ya Kampuni: 686686",
    "haloStep4": "4.Ingiza kumbukumbu namba",
    "haloStep5": "5.Ingiza kiasi",
    "haloStep6": "6.Ingiza PIN yako kuthibitisha",
    "mpesaStep1": "Piga *150*00#",
    "mpesaStep2": "Lipa kwa Mpesa",
    "mpesaStep3": "Weka namba ya Kampuni : 944344",
    "mpesaStep4": "Ingiza kumbukumbu namba inahitajika",
    "mpesaStep5": "Ingiza kiasi",
    "mpesaStep6": "Ingiza PIN yako ya Halo Pesa kuthibitisha",
    "mpesaStep7": "Kubali malipo",
    "afterPaymentMessage": "Baada ya malipo, utapokea ujumbe wa uthibitisho. Usajili wako utakamilika moja kwa moja.",
    "goHome": "Rudi Nyumbani",
 our_team_title: "Kamati ya Maandalizi",
      health_title: "Afya",
       validation_select_payment_method :  "Chagua Mtandao wa malipo",
      education_desc:
        "Kuwezesha  maendeleo ya shule ya sekondari Pugu",
              youth_empowerment_desc:
 ...
 validation_accept_terms :  "Kubali masharti",
   "form.sending":"tuma meseji",
    ...
    'important'              : 'Muhimu',
      // "payViaMobile": "Tafadhali Lipa kwenye Simu",
    "paymentSentInstructions": "Ombi la malipo limetumwa kwenye simu yako. Tafadhali maliza malipo ili kukamilisha usajili, au tumia kumbukumbu namba iliyotumwa kwenye simu yako kwa kutumia namba ya kampuni 686686 kwa mitandao ya Halotel na Mixx by yas. Tumia namba ya kampuni 944344 kwa Vodacom. Kwa Airtel Money chagua Lipa Bili kisha #, chagua  Fintech payment kisha EvMak kisha weka kumbukumbu namba ukianza na maneno EVM.",
     "registrationFee": "Kiasi cha Usajili",
    "contributionAmount": "Kiasi cha Mchango",
     "enterAmount": "Ingiza Kiasi",
       "mshiriki": "Mshiriki",
       "mshiriki1": "Najiunga na mbio za marathon",
    ...
    'ok_pay_later'           : 'Sawa, Nitalipa Baadaye',
      "paymentType": "Chagua Aina ya Malipo",
    "selectPayment": "Chagua aina ya malipo",
    "mobilePayment": "Mtandao wa simu",
    "cardPayment": "Kadi (Visa / MasterCard)",
